...
export function TrendChart({ vista = 'mensual', fechaInicio, fechaFin, refreshTrigger }: TrendChartProps = {}) {
  ...
  useEffect(() => {
    fetchTrendData()
  }, [vista, fechaInicio, fechaFin, refreshTrigger])
  ...
  const fetchTrendData = async () => {
    ...
    if (vista === 'personalizada' && fechaFin) {
